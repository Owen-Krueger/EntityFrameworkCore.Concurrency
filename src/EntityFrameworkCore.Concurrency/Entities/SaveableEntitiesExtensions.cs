...
public static class SaveableEntitiesExtensions
{
    ...
    public static async Task<int> SaveChangesAsync(this ISaveableEntities entities, ConcurrencyConflictApproach approach, CancellationToken cancellationToken = default)
    {
    ...
    /// <exception cref="DbUpdateException">An error is encountered while saving to the database.</exception>
    /// <exception cref="OperationCanceledException">If the <see cref="CancellationToken" /> is canceled.</exception>
    public static async Task<int> SaveChangesAsync(this ISaveableEntities entities, ConcurrencyConflictApproach approach, int retryCount, CancellationToken cancellationToken = default)
    {
